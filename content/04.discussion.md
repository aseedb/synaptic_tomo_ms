...
Functional reconstruction led to the suggestion by some that SNARE-complexes primarily form downstream of Ca2+-influx (PMID: 21642968 ), whereas mutagenesis studies in cells supported the notion that SNARE-complexes had already formed before arrival of the Ca2+-trigger, i.e. during priming (PMID: 20142423). 
In fact, both notions might be partly correct, as the formation of a low number of SNARE-complexes might lead to a stable primed state, defined by a valley in the energy landscape due to the dual inhibitory/stimulatory features of the SNARE-complex (PMID: 20562829, PMID: 30811985  ), whereas more SNARE-complexes might form dynamically after triggering, during membrane fusion itself. 
Accordingly, in in vitro fusion assays additional SNARE-complexes, above those required for fusion pore formation, leads to fusion pore stabilization and release of larger cargos (PMID: 22422984, PMID: 29420480). 
Vesicles that have not formed three tethers before stimulation might fuse with delayed kinetics during triggering, which accounts for the variable exocytosis kinetics among SVs [35,36,37,38]. 
Superprimed vesicles are expected to have formed the largest number of tethers before stimulation (PMID: 23980146 , PMID: 27432975). 
...
Indeed, a number of recent publications have suggested that some SVs can get primed extremely quickly in response to Ca2+ influx (PMID: 31379524, PMID: 34049722, PMID: 32989294, PMID: 27537485, PMID: 32077852).
