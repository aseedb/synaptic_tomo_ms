...
Interestingly, much of the trans-SNARE bundle surface is negatively charged, which contributes to the electrostatic barrier that minimizes spontaneous fusion and allows synaptotagmin-1 to act as an electrostatic switch which triggers exocytosis [@doi:10.1016/j.celrep.2019.01.103].
...
Contrary to the results in the earlier mentioned high-pressure freezing/freeze-substitution EM study, studies using cryo-electron tomography (cryo-ET) revealed that under resting conditions, no SV is in direct contact with the PM and the majority of AZ-proximal SVs are connected to the PM by a variable number of short tethers [@doi:10.1083/jcb.200908082; @doi:10.1016/j.sbi.2019.01.008].
It was hypothesized, that the more gentle freezing conditions during sample preparartion for cryo-electron tomography (cryo-ET) preserves samples closer to in vivo conditions. 
This hyothesis is also supported by the fact, that the observed gap between the SV and the PM is consistent with the model of an electrostatic barrier formed by the negative charges of the SV, the PM, and the trans-SNARE bundle [@doi:10.1016/j.celrep.2019.01.103].
...
In one of them, the term pre-primed pool was used for the few vesicles (~1 vesicle at hippocampal synapses), which are rapidly released and another publication showed that the RRP is made up of only 10-20% of SVs located on the AZ (equal to ~1 vesicle on hippocampal synapses) [@doi:10.1111/j.1469-7793.2001.0481i.x; @doi:10.1523/JNEUROSCI.5231-04.2005].
The ensemble of proximal vesicles which are not in the RRP have been termed non-RRP and presumably belong to the recycling pool that releases more slowly [@doi:10.1083/jcb.200908082; @doi:10.3389/fnsyn.2010.00135].
...
Vesicles in the reserve pool are tightly clustered and well inter-connected by structures, termed connectors [@doi:10.1083/jcb.200908082; @doi:10.3389/fnsyn.2010.00135].
...
On the other hand, to study the consequences of increased or decreased spontaneous synaptic activity, we imaged synapses in mice neuronal culture expressing either wild-type SNAP-25, a more positively charged SNAP-25 mutant (4K mutant), as well as a more negatively charged mutant of SNAP-25 (4E mutant) [@doi:10.1016/j.celrep.2019.01.103].
The more positively-charged SNAP-25 mutant, which is constitutively active showed no triple-tethered SV, which confirmed the morphological definition of the RRP.
...
Altogether, our results indicate a regulation of SV mobility and their recruitment at the AZ PM, through connectors.
