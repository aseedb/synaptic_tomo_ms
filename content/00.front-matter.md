...
+ **{{author.name}}**{% if author.correspondence is defined and author.correspondence == true -%}^[✉](#correspondence)^{%- endif -%}{% if author.equal_contribution is defined and author.equal_contribution == true -%}^[\*](#equal_contribution)^{%- endif -%}<br>
...
{%- if pandoc.keywords is defined and pandoc.keywords|length %}
Keywords: {{pandoc.keywords | join(', ')}}
{%- endif %}