...
In non-sprayed synaptosomes, 54% of the proximal vesicles were tethered, which is in agreement with previous results (Figure {@fig:S1}B) [@doi:10.1083/jcb.200908082]. 
...
53% of the all proximal SVs were tethered and 17% of all proximal SVs belonged to the RRP (Figure {fig:S1}A and Figure {fig:tethers}A). 
