...
Furthermore, we have observed that connectors remained present between fusing SV and neighbor SV (Supplementary Figure @fig:suppl_connected_slices, @fig:suppl_tomogram_slices and Supplementary [Movies S1](#vid:synaptosome) and [S2](#vid:neuron):suppl_synaptosome_late & @mov:suppl_neuron_WT).
