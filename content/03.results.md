...
`\_Removed the sentence about the correlation with electrophysiological data; it is actually quite hard to find a consensual value in the litterature*`{.green}. 
