...
![**3-D rendered segmented tomograms of neuron synapses**. (A) SNAP-25 WT, (B) SNAP-25-4E, (C) SNAP-25-4K. (left) Overview, (right) detail. Blue: synaptic vesicles; purple: active zone plasma memmbrane; yellow: connectors; red: tethers. Scale bars: 100 nm, except in .](images/segmentation_neurons.png){#fig:suppl_segmentation width="15cm" tag="S3"}
